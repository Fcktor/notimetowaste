            ...
            <label key={opt} className="flex items-center gap-2.5 cursor-pointer group">
              <div
                ...
                style={{
                  ...
                  background: selected.includes(opt) ? "#111111" : "transparent",
                  borderRadius: "2px",
                }}
...
export function StorefrontFilters({ products }: { products: Product[] }) {
  ...
  const filtered = useMemo(() => {
    ...
    list = [...list].sort((a, b) => Number(b.available && b.stock > 0) - Number(a.available && a.stock > 0))
    return list
        ...
        <div className="flex items-center gap-2 pb-3">
          {(["priceMin", "priceMax"] as const).map((field, i) => (
            <div key={field} className="flex items-center gap-1 flex-1 px-2 py-1.5"
              style={{ background: "#F9F9F8", border: "1px solid #EAEAEA", borderRadius: "0.375rem" }}>
    ...
    <>
      ...
      <div className="flex items-center justify-between gap-4 mb-8 pb-4 flex-wrap"
        ...
        <button
          ...
          style={{ color: "#787774", border: "1px solid #EAEAEA", borderRadius: "0.375rem" }}
        >
          ...
          <div className="hidden sm:flex items-center" style={{ border: "1px solid #EAEAEA", borderRadius: "0.375rem", overflow: "hidden" }}>
            {([3, 2] as const).map(n => (
              <button key={n} onClick={() => setCols(n)}
                ...
                style={{
                  background: cols === n ? "#F1F0ED" : "transparent",
                  color: cols === n ? "#111111" : "#787774",
                }}>
        ...
        <div className="flex-1 min-w-0">
          ...
          {filtered.length === 0 ? (
            <div className="text-center py-24">
              <p className="text-sm mb-4" style={{ color: "#787774" }}>
        ...
        <div className="fixed inset-0 z-50 flex lg:hidden">
          ...
          <div className="relative ml-auto w-72 h-full flex flex-col"
            ...
            <div className="flex items-center justify-between px-5 py-4"
              style={{ borderBottom: "1px solid #EAEAEA" }}>
              <span style={{ ...LABEL_STYLE, color: "#111111" }}>Filtrar colección</span>
              <button onClick={() => setDrawerOpen(false)} style={{ color: "#787774" }}>
            ...
            <div className="px-5 py-4" style={{ borderTop: "1px solid #EAEAEA" }}>
              <button
                ...
                className="w-full py-3 text-xs uppercase tracking-[0.14em] transition-all duration-150 active:scale-[0.98]"
